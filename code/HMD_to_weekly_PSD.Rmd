...
hmd_data_week <- all_hmd_og |>
  ...
  ungroup() |>
  group_by(network, npz_id, Dep_ID, year_UTC, isoweek_UTC) |>
...
psd_week <- hmd_data_week |>
  ...
  group_by(network, npz_id, Dep_ID, year_UTC, isoweek_UTC, effort_days) |>  
...
write_csv(psd_week, "data/Df_analysis/All_deps_weekly_PSD.csv")
