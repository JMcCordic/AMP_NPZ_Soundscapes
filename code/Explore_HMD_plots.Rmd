...
plotPSD(all_hmd_data, style="quantile", by="season_astro", q=0.1)
ggsave(paste0("figs/", "PSD_season_all.png"), width=12, height=8,
       units="in", dpi=300)



plotPSD(all_hmd_data, style="quantile", by="season_astro", facet = "network", q=0.1)
