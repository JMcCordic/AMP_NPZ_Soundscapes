...
ggplot(data = psd_monthdiel_cluster, 
  ...
  scale_x_log10() +
  scale_color_viridis_d(begin = 0.1, end = 0.8)+
  facet_grid(rows = vars(cluster), cols = vars(npz_id.x))+ 
  theme_bw()
...
#### PERMANOVA test for clusters

perma_cluster <- adonis2(dissim_dist_all~as.factor(nmdsScores_all$npz_id), data = dissim_dist_all, permutations = 9999)
...
# 
# adonis2(formula = dissim_dist_all ~ as.factor(nmdsScores_all$npz_id), data = dissim_dist_all, permutations = 9999)
#          Df SumOfSqs      R2     F Pr(>F)    
# Model     5 0.030540 0.88738 80.37  1e-04 ***
# Residual 51 0.003876 0.11262                 
